...
class StudyGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Study entity")
        ...
        .repeat(2) {
            ...
            .post("/api/studys")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "objective":"SAMPLE_TEXT", "type":null, "startDate":"2020-01-01T00:00:00.000Z", "endDate":"2020-01-01T00:00:00.000Z"}""")).asJSON
            .check(status.is(201))
